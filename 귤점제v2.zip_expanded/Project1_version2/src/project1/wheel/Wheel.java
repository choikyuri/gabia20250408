...
public class Wheel extends JPanel {
	...
	private final Font DEFAULTFONT = new Font("TimesRoman", Font.PLAIN, 5);
	private Font _font = DEFAULTFONT;

	private boolean _spinOnOff = false;
	private double _spinSpeed = 0;
	private double _maxSpinSpeed = 360;
	private double _spinDeceleration = -30; // 감속
	...
	private ArrayList<Color> getDefaultColorList() {
		...
		colors.add(new Color(255,196,155));
		colors.add(new Color(255,158,94));
		colors.add(new Color(255,126,40));
		colors.add(new Color(247,99,0));
		colors.add(new Color(255, 126, 40));
